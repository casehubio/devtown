...
class GovernanceMutationResolverIncidentTest {

    private static final String TENANT = "test-tenant";

    @Inject GovernanceMutationResolver mutationResolver;
    ...
    void reportIncident_delegatesToService() {
        ...
        GovernanceMutationResolver.IncidentReport result = mutationResolver.reportIncident(
    ...
    void reportIncident_invalidSeverity_throws() {
        org.junit.jupiter.api.Assertions.assertThrows(Exception.class,
                () -> mutationResolver.reportIncident(
