...
class CbrReviewerMatchingIntegrationTest {
    ...
    void agentWithLowerTrustButHigherPrecedentMatch_winsOverHigherTrustNoPrecedent() {
        var experiences = List.of(new RetrievedExperience(
                ...
                "specialist-agent", RoutingOutcome.SUCCESS, 0, Map.of())),
                Map.of()));
        ...
        assertThat(selected.bindingNames()).isNotEmpty();
    }
    ...
    void zeroPrecedents_identicalToPureTrustRouting() {
        ...
        assertThat(resultWith).isInstanceOf(ImplementationSelection.Selected.class);
        assertThat(resultWithout).isInstanceOf(ImplementationSelection.Selected.class);
    }
